...
class OCAServerApi_Asset extends OCAServerApi_Entity {
	public $singular = 'asset';
	public $plural = 'assets';
    protected $type;
	...
	public function createSub($typeUrl, $data) {
        ...
        return $this->_create($this->url . '/assets', $data);
	}

	public function subs($params=array()) {
        return parent::_Search($this->client, $this->url . '/assets', $params);
	}
    ...
    static public function Search($client, $params=array()) {
        return parent::_Search($client, '/api/v1/assets', $params);
    }     
    ...
    public function query($params=array()) {
        return $this->_query($this->client, '/api/v1/assets', $params);
    }  
}
